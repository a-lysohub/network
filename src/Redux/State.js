import { renrenderEntireTree } from "../render";
        ...
        dialogData: [
            {
                ...
                name: "Alona",
                ava:
                    "https://images.freeimages.com/images/premium/small-comps/5488/54880574-profile-icon-female-avatar-woman-portrait.jpg",
            },
            {
                id: "2",
                name: "Sasha",
                ava:
                    "https://media.istockphoto.com/vectors/default-avatar-profile-icon-gray-placeholder-photo-vector-id844058816?b=1&k=6&m=844058816&s=612x612&w=0&h=pctweaZOB-hD1VNfAxDJvzsIajhEe81ajHvfAW-tq0o=",
            },
            {
                id: "3",
                name: "Max",
            ...
            },
            {
                ...
                name: "Vlad",
                ava:
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5x8eZ7q-2f-2fwAq3YM6gOFvnluVPvEZ5aw&usqp=CAU",
            },
            {
                id: "8",
                name: "Yurka",
            ...
            },
            {
                ...
                name: "Romka",
                ava:
                    "https://img2.freepng.ru/20180612/ih/kisspng-computer-icons-avatar-user-profile-clip-art-5b1f69f0e68650.4078880515287853929442.jpg",
            },
        ],
        messagesData: [
            { id: "1", message: "hi" },
